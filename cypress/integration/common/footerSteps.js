...
Given("I am an {string} user {string} on {string} viewing {string} for {string}", (userType, modeType, country, currentPage, language) => {
  debugger;
  TestDataHelper.setTestCountry(country, language);
  globalThis.page = PageHelper.createPagewith(currentPage + "Page");
});
